...
function CreateRegions takes nothing returns nothing
    ...
    set gg_rct_BattleAreaBridgeSpawnCreeps=Rect(480.0, 13920.0, 800.0, 14240.0)
    ...
    set gg_rct_InitialPos=Rect(14976.0, - 15872.0, 15520.0, - 15264.0)
endfunction
